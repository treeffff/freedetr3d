...
class NuscMVDetDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        cam_infos = list()
        # TODO: Check if it still works when number of cameras is reduced. Need Test Code
        # TODO: modify code to return depth information
