...
if __name__ == "__main__":
    args = get_args()
    args.out_dir = "/root/autodl-tmp/MonoDETR-main/data/dair_kitti/training/bev_seg"
    args.base_path = "/root/autodl-tmp/MonoDETR-main/data/dair_kitti/training/label_2"
