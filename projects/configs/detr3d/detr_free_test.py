...
point_cloud_range = [-45.0, -5.0, 0.0, 45.0, 5.0, 90.0]  # [x_min, y_min, z_min, x_max, y_max, z_max]
voxel_size = [0.2, 0.2, 8]

img_norm_cfg = dict(
    mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_rgb=True)

# we only test on car class
# TODO: test more classes
class_names = ['car']
...
evaluation = dict(interval=1, pipeline=val_pipeline, metric=['bev', '3d'], save_best='3d', rule='greater')
